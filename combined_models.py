...
def main():
    ...
    prediction_array = [
        {
            "player": "HyDra",
            "game_mode": "HardPoint",
            "player_team": "New_York_Subliners",
            "enemy_team": "OpTic_Texas",
            "teammates": ["KiSMET", "Sib", "Skyz"],
            "enemies": ["Pred", "Shotzzy", "Kenny", "Dashy"],
            "X_value": 27.0,
        },
        {
            "player": "KiSMET",
        ...
        },
        {
            ...
            "enemy_team": "New_York_Subliners",
            "teammates": ["Shotzzy", "Kenny", "Dashy"],
            "enemies": ["HyDra", "KiSMET", "Sib", "Skyz"],
            "X_value": 26.5,
        },
        {
            "player": "Shotzzy",
        ...
        },
        {
            ...
            "game_mode": "HardPoint",
            "player_team": "Atlanta_FaZe",
            "enemy_team": "Toronto_Ultra",
            "teammates": ["aBeZy", "Drazah", "Cellium"],
            "enemies": ["CleanX", "Envoy", "Scrap", "Insight"],
            "X_value": 26.5,
        },
        {
            "player": "aBeZy",
        ...
        },
        {
            "player": "CleanX",
            "game_mode": "HardPoint",
            "player_team": "Toronto_Ultra",
            "enemy_team": "Atlanta_FaZe",
            "teammates": ["Envoy", "Scrap", "Insight"],
            "enemies": ["Simp", "aBeZy", "Drazah", "Cellium"],
            "X_value": 25.5,
        },
        {
            "player": "Envoy",
            ...
            "player_team": "Toronto_Ultra",
            "enemy_team": "Atlanta_FaZe",
            "teammates": ["CleanX", "Scrap", "Insight"],
            "enemies": ["Simp", "aBeZy", "Drazah", "Cellium"],
            "X_value": 23.5,
        },
        {
            ...
            "player_team": "Toronto_Ultra",
            "enemy_team": "Atlanta_FaZe",
            "teammates": ["CleanX", "Envoy", "Insight"],
            "enemies": ["Simp", "aBeZy", "Drazah", "Cellium"],
            "X_value": 26.5,
        },
        {
    ...
    # Load the data
    df = pd.read_csv("./data/Trial7.csv")
